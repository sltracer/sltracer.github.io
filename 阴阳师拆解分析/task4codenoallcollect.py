...
# 打开文件准备写入详细过程
with open('markov_calculation_details_no_allcollect.txt', 'w', encoding='utf-8') as f:
    f.write("《阴阳师》非全集赏抽卡马尔可夫链模型详细计算过程\n")
    f.write("=" * 60 + "\n")
...
# 控制台输出关键结果摘要
print("计算完成！详细过程已保存至文件: markov_calculation_details_no_allcollect.txt\n")
print("关键结果摘要:")
print(f"无全集赏初始状态 (0, 0) 的期望抽数: {E[0][0]:.2f} 抽\n")
